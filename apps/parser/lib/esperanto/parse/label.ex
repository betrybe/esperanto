defmodule Esperanto.Parse.Label do
  ...
  def astify(%Markright.Continuation{ast: {:blockquote, attrs, [<<">",label::binary>> | rest] }} = cont) do
    {label_elements, rest} = Enum.split_while([label] ++ rest, fn
    ...
    {end_element, rest} = case List.pop_at(rest, 0) do
      {nil, rest} -> {nil, rest}
